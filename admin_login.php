...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM user WHERE (username = ? OR email = ?) AND role = 'admin'");
    ...
    if ($admin && password_verify($password, $admin['password'])) {
        ...
        $_SESSION['admin_login_error'] = "Username/email atau password salah, atau Anda bukan admin.";
        header("Location: admin_login.php");
        exit;
    }
}
            ...
            <div class="admin-login-card">
                ...
                <form class="login-form" action="admin_login.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="identifier" name="identifier" class="form-input" placeholder="Masukkan username atau email admin" required>
                    </div>
